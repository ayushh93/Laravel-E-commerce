                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="position" id="position" value="{{ $testimonial->position }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <img src="{{ asset('public/uploads/testimonial/'.$testimonial->image) }}" style="width: 100px" id="one">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="col-md-12">
