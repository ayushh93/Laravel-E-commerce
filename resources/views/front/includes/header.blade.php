                    ...
                    <div class="widget pull-left">
                        <div class="widget-inner">
                            <div id="lang_sel">
                                <ul class="nav">
                                    <li>
                                        <a class="lang_sel_sel">
                                            <img class="iclflag" title="English" alt="en" src="public/frontend/images/icons/en.png" width="18" height="12" /> English
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="#">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="iclflag" title="Arabic" alt="ar" src="public/frontend/images/icons/ar.png" width="18" height="12" /> Arabic
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
        ...
        <div class="container">
            <div class="rows">
                ...
                <div class="etrostore-logo pull-left">
                    <a href="{{ route('index') }}">
                        <img src="{{ asset('public/uploads/'.$theme->logo) }}" alt="{{ $theme->site_title }}">
                    </a>
                </div>
                                        ...
                                        <ul class="minicart-content">
                                            <li>
                                                <a href="simple_product.html" class="product-image">
                                                    <img 	width="100" height="100" src="public/frontend/images/1903/45-150x150.jpg" class="attachment-100x100 size-100x100 wp-post-image" alt=""
                                                            srcset="public/frontend/images/1903/45-150x150.jpg 150w, public/frontend/images/1903/45-300x300.jpg 300w, public/frontend/images/1903/45-180x180.jpg 180w, public/frontend/images/1903/45.jpg 600w"
                                            ...
                                            <li>
                                                <a href="simple_product.html" class="product-image">
                                                    <img 	width="100" height="100" src="public/frontend/images/1903/22-150x150.jpg" class="attachment-100x100 size-100x100 wp-post-image" alt=""
                                                            srcset="public/frontend/images/1903/22-150x150.jpg 150w, public/frontend/images/1903/22-300x300.jpg 300w, public/frontend/images/1903/22-180x180.jpg 180w, public/frontend/images/1903/22.jpg 600w"
                                                            sizes="(max-width: 100px) 100vw, 100px" />
                                                </a>
                            ...
                            <ul id="menu-primary-menu-1" class="nav nav-pills nav-mega etrostore-mega etrostore-menures">
                                ...
                                <li class="dropdown menu-shop etrostore-mega-menu level1 etrostore-menu-img">
                                    <a href="#" class="item-link dropdown-toggle">
												<span class="have-title">
													...
													<span class="menu-img">
														<img src="public/frontend/images/1903/icon-new-1.png" alt="Menu Image" />
													</span>
                                    ...
                                    <ul class="dropdown-menu nav-level1 column-4">
                                        <li class="dropdown-submenu column-4 menu-electronics etrostore-menu-img">
                                            <a href="#">
														<span class="have-title">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn3.jpg" alt="Menu Image" />
															</span>
                                        ...
                                        <li class="dropdown-submenu column-4 menu-smartphone etrostore-menu-img">
                                            <a href="#">
														<span class="have-title">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn4.jpg" alt="Menu Image" />
															</span>
                                        ...
                                        <li class="dropdown-submenu column-4 menu-tablet etrostore-menu-img">
                                            <a href="#">
														<span class="have-title">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn5.jpg" alt="Menu Image" />
															</span>
                                        ...
                                        <li class="dropdown-submenu column-4 menu-computer etrostore-menu-img">
                                            <a href="#">
														<span class="have-title">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn6.jpg" alt="Menu Image" />
															</span>
                                    ...
                                    <ul class="dropdown-menu nav-level1 column-4">
                                        ...
                                        <li class="image-fix column-4 menu-image etrostore-menu-img">
                                            <a href="#">
														<span class="">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn1.jpg" alt="Menu Image" />
															</span>
														</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="image-fix column-4 menu-image etrostore-menu-img">
                                            <a href="#">
														<span class="">
															<span class="menu-img">
																<img src="public/frontend/images/1903/menu-bn2.jpg" alt="Menu Image" />
															</span>
														</span>
                                            </a>
                                        </li>
                                ...
                                <li class="menu-deals etrostore-menu-custom level1 etrostore-menu-img">
                                    <a href="deals.html" class="item-link">
												<span class="have-title">
													<span class="menu-img">
														<img src="public/frontend/images/1903/icon-hot.png" alt="Menu Image" />
													</span>
